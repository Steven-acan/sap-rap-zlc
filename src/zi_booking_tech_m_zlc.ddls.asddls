...
define view entity ZI_BOOKING_TECH_M_ZLC
  as select from zbooking_techmlc
  
  association to parent ZI_TRAVEL_TECH_M_ZLC as _Travel 
  on $projection.TravelId = _Travel.TravelId
  composition [0..*] of ZI_BOOKSUPPLTECHM as _Bookingsuppl
